...
export default function RegisterClient() {
  ...
  const handleImageChange = async (event) => {
    ...
    try {
      ...
      setImageUrl(url);
      toast.success("à¦ªà§à¦°à§‹à¦«à¦¾à¦‡à¦² à¦›à¦¬à¦¿ à¦†à¦ªà¦²à§‹à¦¡ à¦¹à¦¯à¦¼à§‡à¦›à§‡à¥¤");
    } catch (error) {
      toast.error(error.message || "à¦›à¦¬à¦¿ à¦†à¦ªà¦²à§‹à¦¡ à¦¬à§à¦¯à¦°à§à¦¥ à¦¹à¦¯à¦¼à§‡à¦›à§‡à¥¤");
      setImageUrl("");
      setImagePreview("");
    } finally {
      setUploading(false);
  ...
  const handleSubmit = async (event) => {
    ...
    if (password !== confirmPassword) {
      toast.error("à¦ªà¦¾à¦¸à¦“à¦¯à¦¼à¦¾à¦°à§à¦¡ à¦à¦¬à¦‚ à¦¨à¦¿à¦¶à§à¦šà¦¿à¦¤à¦•à¦°à¦£ à¦ªà¦¾à¦¸à¦“à¦¯à¦¼à¦¾à¦°à§à¦¡ à¦®à¦¿à¦²à¦›à§‡ à¦¨à¦¾à¥¤");
      return;
    }
    if (password.length < 8) {
      toast.error("à¦ªà¦¾à¦¸à¦“à¦¯à¦¼à¦¾à¦°à§à¦¡ à¦•à¦®à¦ªà¦•à§à¦·à§‡ à§® à¦…à¦•à§à¦·à¦°à§‡à¦° à¦¹à¦¤à§‡ à¦¹à¦¬à§‡à¥¤");
      return;
    }
    ...
    try {
      ...
      if (!response.ok || !result.success) {
        toast.error(result.message || "à¦¨à¦¿à¦¬à¦¨à§à¦§à¦¨ à¦¬à§à¦¯à¦°à§à¦¥ à¦¹à¦¯à¦¼à§‡à¦›à§‡à¥¤");
        return;
      }

      toast.success(result.message || "à¦¨à¦¿à¦¬à¦¨à§à¦§à¦¨ à¦¸à¦«à¦² à¦¹à¦¯à¦¼à§‡à¦›à§‡!");
      router.push("/login");
    } catch (error) {
      toast.error("à¦¨à¦¿à¦¬à¦¨à§à¦§à¦¨à§‡à¦° à¦¸à¦®à¦¯à¦¼ à¦¸à¦®à¦¸à§à¦¯à¦¾ à¦¹à¦¯à¦¼à§‡à¦›à§‡à¥¤ à¦…à¦¨à§à¦—à§à¦°à¦¹ à¦•à¦°à§‡ à¦†à¦¬à¦¾à¦° à¦šà§‡à¦·à§à¦Ÿà¦¾ à¦•à¦°à§à¦¨à¥¤");
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <CardHeader className="items-center text-center px-6 pt-4 pb-1">
          ...
          >
            <CardTitle className="text-xl font-bold text-brand-700 sm:text-2xl">
              à¦¨à¦¤à§à¦¨ à¦…à§à¦¯à¦¾à¦•à¦¾à¦‰à¦¨à§à¦Ÿ à¦¤à§ˆà¦°à¦¿ à¦•à¦°à§à¦¨
            </CardTitle>
          </motion.div>
          <motion.div
            variants={fadeUp}
          ...
          >
            <CardDescription className="mx-auto max-w-sm text-xs leading-relaxed text-ink-700 sm:text-sm">
              à¦¨à¦¿à¦¬à¦¨à§à¦§à¦¨à§‡à¦° à¦ªà¦° à¦à¦¡à¦®à¦¿à¦¨ à¦…à¦¨à§à¦®à§‹à¦¦à¦¨ à¦ªà¦°à§à¦¯à¦¨à§à¦¤ à¦…à¦ªà§‡à¦•à§à¦·à¦¾ à¦•à¦°à¦¤à§‡ à¦¹à¦¬à§‡à¥¤
            </CardDescription>
          </motion.div>
        </CardHeader>
          ...
          >
            <div className="flex items-center gap-4 rounded-xl border border-brand-200 bg-brand-50/50 p-3">
              <div className="relative shrink-0">
                <Avatar className="size-14 text-large ring-2 ring-brand-100 shadow-sm">
                  {imagePreview ? (
                    <Avatar.Image src={imagePreview} alt="à¦ªà§à¦°à§‹à¦«à¦¾à¦‡à¦² à¦›à¦¬à¦¿" />
                  ) : null}
                  <Avatar.Fallback>
              ...
              <div className="min-w-0 flex-1">
                <p className="text-[13px] font-medium text-ink-800">
                  à¦ªà§à¦°à§‹à¦«à¦¾à¦‡à¦² à¦›à¦¬à¦¿ <span className="font-normal text-ink-500">(à¦à¦šà§à¦›à¦¿à¦•)</span>
                </p>
                <div className="mt-1.5">
                  <label className="inline-flex w-fit cursor-pointer items-center gap-1.5 rounded-lg bg-white px-3 py-1.5 text-xs font-semibold text-brand-700 shadow-sm ring-1 ring-brand-200 transition hover:bg-brand-50">
                    ...
                    {uploading ? "à¦†à¦ªà¦²à§‹à¦¡ à¦¹à¦šà§à¦›à§‡â€¦" : "à¦ªà§à¦°à§‹à¦«à¦¾à¦‡à¦² à¦›à¦¬à¦¿ à¦†à¦ªà¦²à§‹à¦¡ à¦•à¦°à§à¦¨"}
                    <input
                      type="file"
                ...
                <p className="mt-1.5 flex items-center gap-1 text-[11px] leading-none text-ink-500">
                  ...
                  JPG, PNG, WEBP, GIF â€” à¦¸à¦°à§à¦¬à§‹à¦šà§à¦š {MAX_SIZE_MB}MB
                </p>
              </div>
            </div>
            ...
            >
              ...
              <SearchInput
                ...
                className="mt-1 rounded-lg"
              />
              <FieldError>à¦ªà¦¾à¦¸à¦“à¦¯à¦¼à¦¾à¦°à§à¦¡ à¦•à¦®à¦ªà¦•à§à¦·à§‡ à§® à¦…à¦•à§à¦·à¦°à§‡à¦° à¦¹à¦¤à§‡ à¦¹à¦¬à§‡à¥¤</FieldError>
            </TextField>
            ...
            >
              ...
              <SearchInput
                icon={Lock}
                placeholder="à¦†à¦¬à¦¾à¦° à¦ªà¦¾à¦¸à¦“à¦¯à¦¼à¦¾à¦°à§à¦¡ à¦²à¦¿à¦–à§à¦¨"
                autoComplete="new-password"
                endContent={
                  <button
                    type="button"
                    onClick={() => setShowConfirmPassword((v) => !v)}
                    aria-label={showConfirmPassword ? "à¦ªà¦¾à¦¸à¦“à¦¯à¦¼à¦¾à¦°à§à¦¡ à¦²à§à¦•à¦¾à¦¨" : "à¦ªà¦¾à¦¸à¦“à¦¯à¦¼à¦¾à¦°à§à¦¡ à¦¦à§‡à¦–à§à¦¨"}
                    className="flex items-center text-ink-600 transition hover:text-ink-800"
                  >
                    {showConfirmPassword ? (
                ...
                className="mt-1 rounded-lg"
              />
              <FieldError>à¦ªà¦¾à¦¸à¦“à¦¯à¦¼à¦¾à¦°à§à¦¡ à¦¦à§à¦Ÿà¦¿ à¦à¦•à¦‡ à¦¹à¦¤à§‡ à¦¹à¦¬à§‡à¥¤</FieldError>
            </TextField>
            ...
            >
              {submitting ? <PrinterLoader compact size={0.3} /> : "à¦¨à¦¿à¦¬à¦¨à§à¦§à¦¨ à¦•à¦°à§à¦¨"}
            </Button>
          </motion.form>
        </CardContent>
